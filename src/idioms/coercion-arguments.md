...
ลองพิจารณาตัวอย่างที่เราต้องการตรวจสอบว่าคำๆ หนึ่งมีสระติดกันสามตัวหรือไม่ เราไม่จำเป็นต้องเป็นเจ้าของสตริงเพื่อตรวจสอบสิ่งนี้ จึงใช้การอ้างอิงแทน
...
แต่เดี๋ยวก่อน ยังมีมากกว่านั้น! เรื่องนี้ยังมีประเด็นต่ออีก คุณอาจคิดในใจว่า ไม่เป็นไรหรอก ยังไงก็ไม่เคยใช้ `&'static str` เป็นข้อมูลนำเข้าอยู่ดี (อย่างที่เราทำตอนใช้ `"Ferris"`) แม้จะมองข้ามตัวอย่างพิเศษนี้ไป คุณก็ยังคงพบว่าการใช้ `&str` ให้ความยืดหยุ่นมากกว่าการใช้ `&String`
