...
ไลบรารีมาตรฐานใช้แนวทางนี้ในเมท็อดอย่าง `String::from_utf8` เมื่อได้รับเวกเตอร์ที่ไม่มี UTF-8 ที่ถูกต้อง จะมี `FromUtf8Error` ถูกคืนกลับมา คุณได้เวกเตอร์ตัวเดิมคืนมาโดยใช้เมท็อด `FromUtf8Error::into_bytes`
