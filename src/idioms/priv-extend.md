...
ข้อเสียของแนวทางนี้คือคุณอาจต้องเพิ่มฟิลด์ที่ไม่จำเป็นอื่นๆ เข้าไปใน struct คุณใช้ชนิด `()` ได้เพื่อไม่ให้มีค่าใช้จ่ายตอนรันไทม์ และใส่ `_` นำหน้าชื่อฟิลด์เพื่อหลีกเลี่ยงคำเตือนเรื่องฟิลด์ที่ไม่ได้ใช้
