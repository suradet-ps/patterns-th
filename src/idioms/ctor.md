...
**คำแนะนำ:** ข้อดีของการอิมพลีเมนต์หรือ derive `Default` คือตอนนี้ชนิดข้อมูลของคุณสามารถใช้ในที่ที่ต้องการการอิมพลีเมนต์ `Default` ได้ โดยที่เด่นชัดที่สุดคือฟังก์ชัน [`*or_default` ใดๆ ในไลบรารีมาตรฐาน][std-or-default]
