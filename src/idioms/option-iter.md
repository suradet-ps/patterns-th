...
นอกจากนี้ เนื่องจาก `Option` อิมพลีเมนต์ `IntoIterator` เราจึงวนซ้ำบนมันด้วยลูป `for` ได้ ซึ่งเทียบเท่ากับการจับคู่ด้วย `if let Some(..)` แต่ในกรณีส่วนใหญ่คุณควรเลือกใช้แบบหลังมากกว่า
